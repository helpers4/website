...
```toml
[dependencies]
helpers4 = { version = "0.0.3", default-features = false, features = ["http"] }
```
...
[src/http/bearer_token.rs](https://github.com/helpers4/rust/blob/v0.0.3/src/http/bearer_token.rs#L25)
