...
A helper named `isEmpty` also exists in [`@helpers4/array`](../array/isempty/), [`@helpers4/object`](../object/isempty/), [`@helpers4/type`](../type/isempty/). If you need both in the same file, rename at import with `as`:
...
[View source on GitHub](https://github.com/helpers4/typescript/blob/main/helpers/string/isEmpty.ts)
