...
sidebar:
  label: "hexToRgb"
description: "Parses a hex color string (`#rgb`, `#rgba`, `#rrggbb`, `#rrggbbaa` — the leading `#` is optional) into its RGB(A) cha…"
---
...
[View source on GitHub](https://github.com/helpers4/typescript/blob/main/helpers/color/hexToRgb.ts)
