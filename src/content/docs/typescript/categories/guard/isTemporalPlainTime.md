...
description: "Checks if a value is a `Temporal.PlainTime`."
version: "3.1.0"
---
...
[View source on GitHub](https://github.com/helpers4/typescript/blob/main/helpers/guard/isTemporalPlainTime.ts)
