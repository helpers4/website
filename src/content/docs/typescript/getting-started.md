...
**[v3.0.4](https://github.com/helpers4/typescript/releases/tag/v3.0.4)** — [npm](https://www.npmjs.com/package/@helpers4/all/v/3.0.4) · [Changelog](../reference/changelog) · Upgrading from v2? See the [migration guide](../reference/migration/)
:::
...
- **Mutation testing** (Stryker) — >90% score; [view dashboard](https://dashboard.stryker-mutator.io/reports/github.com/helpers4/typescript/v3.0.4)
