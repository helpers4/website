...
**[v2.0.2](https://github.com/helpers4/typescript/releases/tag/v2.0.2)** — [npm](https://www.npmjs.com/package/@helpers4/all/v/2.0.2) · [Changelog](../reference/changelog)
:::
...
- **Mutation testing** (Stryker) — >90% score; [view dashboard](https://dashboard.stryker-mutator.io/reports/github.com/helpers4/typescript/v2.0.2)
