...
**[v3.1.0](https://github.com/helpers4/typescript/releases/tag/v3.1.0)** — [npm](https://www.npmjs.com/package/@helpers4/all/v/3.1.0) · [Changelog](../reference/changelog) · Upgrading from v2? See the [migration guide](../reference/migration/)
:::
...
- **Mutation testing** (Stryker) — >90% score; [view dashboard](https://dashboard.stryker-mutator.io/reports/github.com/helpers4/typescript/v3.1.0)
