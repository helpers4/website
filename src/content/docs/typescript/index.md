...
- **[Browse Categories](./categories/array)** — 208 helpers across 16 categories
...
| **Mutation testing** | >90% score — tests verified to catch regressions, not just execute — [dashboard](https://dashboard.stryker-mutator.io/reports/github.com/helpers4/typescript/v2.0.2) |
