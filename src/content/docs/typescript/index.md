...
- **[Browse Categories](./categories/array)** — 317 helpers across 20 categories
...
| **Mutation testing** | >90% score — tests verified to catch regressions, not just execute — [dashboard](https://dashboard.stryker-mutator.io/reports/github.com/helpers4/typescript/v3.0.7) |
