...
- **[Browse Categories](./categories/array)** — 333 helpers across 22 categories
...
| **Mutation testing** | >90% score — tests verified to catch regressions, not just execute — [dashboard](https://dashboard.stryker-mutator.io/reports/github.com/helpers4/typescript/v3.1.2) |
