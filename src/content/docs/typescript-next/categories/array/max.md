...
`number | undefined` — Maximum value, `undefined` for empty arrays, `null`, `undefined`, or `NaN` if any element is `NaN`
...
[View source on GitHub](https://github.com/helpers4/typescript/blob/v3/helpers/array/max.ts)
