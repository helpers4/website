...
|----------|-------------|
| [`debounce`](debounce) | Creates a debounced function that delays invoking func until after delay milliseconds have elapsed since the last time the debounced function was invoked |
