---
sidebar_label: License (LGPL-3.0)
---
...
The complete license text is available at [gnu.org/licenses/lgpl-3.0](https://www.gnu.org/licenses/lgpl-3.0.html) and in the [LICENSE](https://github.com/helpers4/devcontainer/blob/main/LICENSE) file of each repository.
