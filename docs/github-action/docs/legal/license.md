...
The complete license text is available at [gnu.org/licenses/agpl-3.0](https://www.gnu.org/licenses/agpl-3.0.html) and in the [LICENSE](https://github.com/helpers4/action/blob/main/LICENSE) file of each repository.
